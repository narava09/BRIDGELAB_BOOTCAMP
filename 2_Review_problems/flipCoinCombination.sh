...
flip_coin_winning_percentage singlet_combinations singlet_combination_percentages
echo 
echo "For Doublet Combination"
flip_coin_winning_percentage doublet_combinations doublet_combination_percentages
echo

echo "For Triplet Combination"
flip_coin_winning_percentage triplet_combinations triplet_combination_percentages
echo

echo "For All Combinations"
flip_coin_winning_percentage total_combinations total_combination_percentages
